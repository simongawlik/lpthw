...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "The Gothon stops, tries not to laugh, then busts out laughin and can't move."
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print "The lock buzzes one last time and then you hear the sickening"
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print "As you doe you see another Gothon frantically try to disarm"
